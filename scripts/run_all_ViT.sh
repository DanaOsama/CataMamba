...
python train.py --run_name 101-seed1 --seed 1 --architecture ViT --epochs 50 --optimizer AdamW --num_clips 8 --clip_size 18 --step_size 2 --weight_decay 0.3 --learning_rate 5e-5 --label_smoothing 0.11 --scheduler Cosine --clip-grad-norm False --wandb_run_id 2qsbah0r --resume_training True