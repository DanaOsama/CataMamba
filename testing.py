from dataloaders import Cataracts_101_21
...
def sample_random_images(data_loader, num_samples=16):
    ...
    for batch in data_loader:
        ...
        batch_images = batch[0][0]  # Adjust this if your DataLoader structure is different
...
# Create a dataset
train_dataset = Cataracts_101_21(data_list=data, root_dir=root_dir, transform=transform)
